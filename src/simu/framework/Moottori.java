...
public abstract class Moottori extends Thread implements IMoottori{  // UUDET MÄÄRITYKSET
	...
	protected IController kontrolleri; // UUSI
	

	public Moottori(IController kontrolleri){  // UUSITTU
	...
	private boolean simuloidaan(){
		//Trace.out(Trace.Level.INFO, "moottori: ", "Kello on: " + kello.getAika());
		return kello.getAika() < simulointiaika;
	}
	
			
	private void viive() { // UUSI
		//Trace.out(Trace.Level.INFO, "moottori: ", "Viive " + viive);
		try {
			sleep(viive);
